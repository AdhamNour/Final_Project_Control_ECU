...
typedef enum {HMI_SET_PASSWORD='A',HMO_CHECK_PASSWORD,HMI_OPEN_DOOR,HMI_PASSWORD_WRONG_THREE_TIMES} HMICommand;
typedef enum {HMI_CORRECT_PASSWORD='a',HMI_WRONG_PASSWORD} PasswordStatus;
typedef enum {DOOR_OPENING='A',DOOR_OPENED,DOOR_CLOSED} DoorStatus;
